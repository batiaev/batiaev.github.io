...
const TakeHome = () => {
  ...
  return (
    <ToolLayout
      ...
      title="The same money, four ways"
      intro={
        <>
          Employed, self-employed, through your own company, or via an umbrella.
          The income tax is nearly identical in all four — the difference is
          employer NI, Class 4, corporation tax and dividend tax, and it is worth
          far more than any band.
        </>
      }
    >
      <div className="grid gap-4 sm:flex sm:flex-wrap sm:items-end">
        <div className="sm:w-44">
          <Field label="Income a year" hint="Salary, or revenue / day rate">
            <NumberField
        ...
        <Popover>
          ...
          <PopoverContent
            align="start"
            className="max-h-[70vh] w-[calc(100vw-2rem)] space-y-4 overflow-y-auto sm:w-96"
          >
            <div>
